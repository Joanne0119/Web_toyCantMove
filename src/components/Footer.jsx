...
const Footer = () => {
    const [isFullscreen, toggleFullscreen, isSupported] = useFullscreen(null);

    return (
        <div className='navbar absolute bottom-0 left-0 right-0 z-20 justify-end'>
            {isSupported && (
                <button 
                    id="fullscreen-btn" 
                ...
                >
                    {isFullscreen ? (
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" strokeWidth={1.8} stroke="white" className="w-6 h-6">
