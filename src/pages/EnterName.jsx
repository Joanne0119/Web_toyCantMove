...
const EnterName = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center safe-area-bottom" data-theme="dark" style={{ backgroundImage: "url('/images/coverLarge.png')", backgroundSize: 'cover', backgroundPosition: 'left 47% center', minHeight: '100dvh'}}>
